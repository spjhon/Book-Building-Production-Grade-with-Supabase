...
export default async function RegisterPage({
  ...
  const { data: tenantData, error: errorFetchingTenantData } =
    await fetchTenantDataCached(tenant);

  if (!tenantData || errorFetchingTenantData) {
    const errorMessage =
      typeof errorFetchingTenantData === "string"
  ...
  const information = [
    {
      quote: t("register_info_quote_1"),
      author: t("register_info_author_1"),
      role: t("register_info_role_1"),
      avatar: "01",
    },
    {
      quote: t("register_info_quote_2"),
      author: t("register_info_author_2"),
      role: t("register_info_role_2"),
      avatar: "02",
    },
    {
      quote: t("register_info_quote_3"),
      author: t("register_info_author_3"),
      role: t("register_info_role_3"),
      avatar: "03",
    },
  ];
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center py-12 px-4 bg-white relative">
        ...
        <div className="">
          ...
          <p className="mt-2 text-center text-sm text-black/60">
            {t("register_org_subtitle", {
              orgName: tenantData.name || "your organization",
            })}
          </p>
        </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-3">
                      ...
                      <p className="text-sm text-primary-200">{info.role}</p>
                    </div>
                  </div>
                </div>
              </div>
